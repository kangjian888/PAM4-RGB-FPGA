...
#
# Generated by Vivado on Wed Jul 17 19:59:09 +0800 2019
...
# Script info
echo -e "clk_gen.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../clk_gen/clk_gen_clk_wiz.v" \
    "$ref_dir/../../../../clk_gen/clk_gen.v" \
  2>&1 | tee -a vlogan.log
