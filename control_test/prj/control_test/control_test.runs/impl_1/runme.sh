...
HD_PWD='D:/OneDrive - HKUST Connect/Lab/PAM4-RGB-FPGA/control_test/prj/control_test/control_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log control_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source control_top.tcl -notrace
